...
module.exports = {
    ...
    async start(context) {
        ...
        // For example: `select * from mysql_test where updated_at > ?`. The logic behind the special placeholder
        ...
        let lock;
        try {
            lock = await context.lock('MySQLUpdatedRow-' + context.componentId, {
                ttl: 1000 * 60 * 5,
                maxRetryCount: 0
            });
